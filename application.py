...
if st.button('Predict'):
   ...
   # Display a caption with black text using st.markdown
st.markdown(
    "<p style='color: black; text-align: center;'>R-squared (Train): 0.9135524926797545 and Normalized MSE:0.0036</p>", 
    unsafe_allow_html=True
)
